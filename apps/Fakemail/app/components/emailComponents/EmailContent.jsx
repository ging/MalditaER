    ...
    return <div className="col3">
      {email ? (
        ...
        <div key="1" className="mail_main">
          <div className="mail_top">
            <div className="info">
              ...
              <div className="contact">
                ...
                {this.props.I18n.getTrans("i.for")}: {profile.email}
                </div>
              </div>
            </div>
          ...
          <div className="mail_content" >
            ...
            <div className="mail_actions" style={{visibility:"hidden"}}>
              <div className="action"><span><i className="fas fa-reply" /></span>{this.props.I18n.getTrans("i.answer")}</div>
              <div className="action"><span><i className="fas fa-share" /></span>{this.props.I18n.getTrans("i.send")}</div>
            </div>
          </div>
        </div>]
      ) : (
        <div key="2"className="no_mail">
          ...
          <div className="nm_text">{this.props.I18n.getTrans("i.noneselected")}</div>
        </div>
      ) }
    </div>;
  }
